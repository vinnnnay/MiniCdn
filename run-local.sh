...
SIMULATED_CLIENT_LATENCY_MS="${SIMULATED_CLIENT_LATENCY_MS:-110}"
...
PORT=$ORIGIN_PORT REDIS_URL=$REDIS_URL DEFAULT_MAX_AGE_SECONDS=$DEFAULT_MAX_AGE_SECONDS SIMULATED_CLIENT_LATENCY_MS=$SIMULATED_CLIENT_LATENCY_MS node origin/dist/server.js &
ORIGIN_PID=$!
